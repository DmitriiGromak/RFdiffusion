...
zdna_coords = [17.075, 16.217, 17.345], [20.769, 13.67, 23.485], [15.286, 12.446, 24.378], [15.448, 8.277, 30.71], [11.854, 12.281, 31.863], [8.734, 10.351, 38.526]
...
class zdna_binder(Potential, torch.nn.Module):
    ...
    def weighted_kabsch(self, P, Q, W):
        ...
        return R.to(dtype), (centroid_P - centroid_Q @ R).to(dtype)
